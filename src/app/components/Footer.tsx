  ...
  return (
    <footer className="bg-[#1E212C] text-white">
      <div className="container mx-auto ">
        <div className="body py-20 flex items-start gap-2">
          <div className="info w-2/5">
            ...
            <ul className="social-media flex gap-6 items-center">
          ...
          <div className="contact w-1/5">
            ...
            <div className="opacity-50 flex flex-col gap-4 mt-4">
              <p className="contact-phone">(405) 555-0128</p>
              <p className="contact-mail">hello@createx.com</p>
            </div>
          </div>
